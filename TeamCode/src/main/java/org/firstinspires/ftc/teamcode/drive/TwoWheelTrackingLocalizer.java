...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PERPENDICULAR_X = 4.4;
    public static double PERPENDICULAR_Y = -0.5;

    public static double X_MULTIPLIER = 1; // Multiplier in the X direction (parallel)
    public static double Y_MULTIPLIER = 1; // Multiplier in the Y direction (perpendicular)
