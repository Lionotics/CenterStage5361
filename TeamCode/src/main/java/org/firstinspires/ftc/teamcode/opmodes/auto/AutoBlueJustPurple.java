...
public class AutoBlueJustPurple extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence placeLeft = drive.trajectorySequenceBuilder(startPose)
                .splineTo(new Vector2d(AutoConstants.BLUE_LEFT_LEFT_SPIKEMARK.getX(),AutoConstants.RED_RIGHT_LEFT_SPIKEMARK.getY()),AutoConstants.RED_RIGHT_LEFT_SPIKEMARK.getHeading())
                .build();

        TrajectorySequence placeCenter = drive.trajectorySequenceBuilder(startPose)
                .splineTo(new Vector2d(AutoConstants.BLUE_LEFT_CENTER_SPIKEMARK.getX(),AutoConstants.RED_RIGHT_CENTER_SPIKEMARK.getY()),AutoConstants.RED_RIGHT_CENTER_SPIKEMARK.getHeading())
                .build();

        TrajectorySequence placeRight = drive.trajectorySequenceBuilder(startPose)
                .splineTo(new Vector2d(AutoConstants.BLUE_LEFT_RIGHT_SPIKEMARK.getX(),AutoConstants.RED_RIGHT_RIGHT_SPIKEMARK.getY()),AutoConstants.RED_RIGHT_RIGHT_SPIKEMARK.getHeading())
                .build();
